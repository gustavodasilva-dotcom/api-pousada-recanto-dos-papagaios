...
AS
	BEGIN
		...
		-- Atualizando a acomodação reservada como "Ocupada".
...
--DROP PROCEDURE IF EXISTS InserirCheckIn
CREATE PROCEDURE InserirCheckIn
	@IdReserva int,		@IdFuncionario int
AS
	BEGIN
...
--DROP PROCEDURE IF EXISTS ObterCheckIns
