...
(
	...
	-- O ATRIBUTO EXCLUÍDO PERMITE QUE, EM VEZ DE EXCLUIR O REGISTRO, SEJA POSSÍVEL APENAS SELECIONAR OS
	-- REGISTRO QUE TENHAM COMO VALOR EM EXCLUÍDO QUALQUER COISA QUE SEJA DIFERENTE DE 1, QUE É TRUE. OU
	-- SEJA, O REGISTRO ESTÁ EXCLUÍDO? FALSE (0).
...
(
	...
	-- HÁ O CPF DO HÓSPEDE COMO UM ATRIBUTO PARA QUE SEJA POSSÍVEL BUSCAR HÓSPEDES ATRAVÉS DO CPF. O SE-
	-- LECT É FEITO BUSCANDO UM CPF EM COMUM EM AMBAS AS TABELAS HÓSPEDE E ENDEREÇO.
...
INSERT INTO INFORMACOES_ACOMODACAO VALUES (35.00, 4, 'Double', 530.00, 1);
INSERT INTO INFORMACOES_ACOMODACAO VALUES (40.00, 3, 'Double', 580.00, 2);
INSERT INTO INFORMACOES_ACOMODACAO VALUES (45.00, 3, 'Double', 650.00, 3);
...
DROP TABLE IF EXISTS HOSPEDE_RESERVA;
CREATE TABLE HOSPEDE_RESERVA
(
	HSP_RES_ID_INT INT NOT NULL IDENTITY(1, 1),
	HSP_RES_HOSPEDE_CPF_STR CHAR(11) NOT NULL,
	HSP_RES_RESERVA_ID_INT INT NOT NULL,
	HSP_RES_HOSPEDE_ID_INT INT NOT NULL,
	HSP_RES_EXCLUIDO_BIT BIT

	CONSTRAINT PK_HSP_RES_ID_INT PRIMARY KEY(HSP_RES_ID_INT),

	CONSTRAINT FK_HSP_RES_HOSPEDE_ID_INT FOREIGN KEY(HSP_RES_HOSPEDE_ID_INT)
	REFERENCES HOSPEDE(HSP_ID_INT),

	CONSTRAINT FK_HSP_RES_RESERVA_ID_INT FOREIGN KEY(HSP_RES_RESERVA_ID_INT)
