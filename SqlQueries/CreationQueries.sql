...
INSERT INTO PAGAMENTO VALUES (1, 4); -- 1
INSERT INTO PAGAMENTO VALUES (2, 4); -- 2
INSERT INTO PAGAMENTO VALUES (3, 4); -- 3
INSERT INTO PAGAMENTO VALUES (4, 4); -- 4
INSERT INTO PAGAMENTO VALUES (5, 4); -- 5
INSERT INTO PAGAMENTO VALUES (6, 4); -- 6
...
(
	...
	--CHECKIN_VALOR_TOTAL_FLOAT FLOAT(2) NOT NULL,
	--CHECKIN_VALOR_UNIT_FLOAT FLOAT(2) NOT NULL,
	CHECKIN_RES_ID_INT INT,
	--CHECKIN_PGTO_ID_INT INT,
	...
	--CONSTRAINT FK_CHECKIN_PGTO_ID_INT FOREIGN KEY(CHECKIN_PGTO_ID_INT)
	--REFERENCES PAGAMENTO(PGTO_ID_INT),
